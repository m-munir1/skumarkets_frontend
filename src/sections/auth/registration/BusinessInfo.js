...
const BusinessInfo = ({setCurrentStep}) => {
  ...
  return (
  <Box sx={{width: '100%'}}>
    <Typography variant='h5' sx={{mb: 4}}>Please fill the Business Info</Typography>
          ...
          <Grid container sx={{alignItems: "center", my: 3}}>
            ...
            <Grid container sx={{alignItems: "center", my: 3}}>
              ...
              <Grid item xs={12} md={9.5}>
                ...
                >
                  <option style={{padding: '10px'}} value="company">By Your Company</option>
                  <option style={{padding: '10px'}} value="courier">By Courier Company</option>
                </RHFSelect>
              </Grid>
            </Grid>
