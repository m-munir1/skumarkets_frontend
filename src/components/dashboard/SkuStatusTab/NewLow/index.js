import { Box, Divider, Grid, Pagination, TablePagination } from '@mui/material';
...
const fields = 'sku_marketplace,sku,current_price,is_live,buy_box_currency,all_images,brand_en,category_en,price_change,current_price,number_of_sellers';
