...
const BillingOverviewOther = ({ setActiveTab, refetch }) => {
  ...
  return (
    <>
            ...
            >
              <Grid container>
                ...
                <Grid item xs={12} md={2}>
                  <Typography variant="subtitle2">Balance From {prev_month}</Typography>
      ...
      <MakeAPaymentModal open={open} handleClose={handleClose} data={lastPlan} refetch={refetch} />
    </>
  );
};
